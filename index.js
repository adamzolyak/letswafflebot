module.exports = app => {
  ...
  app.on('issues.labeled', async context => {
  	...
  	const eventSender = context.payload.sender.login
  ...
  app.on('check_suite.requested', async context => {
      const prSHA = context.payload.check_suite.head_sha

      const createPullRequestCheck = context.issue({name:"Automated Integration Tests", head_sha:prSHA,status:"in_progress",started_at:nowGHFormatted(),details_url:"https://www.waffle.io/features/automation/",external_id:prSHA})
      ...
      .then(function(newPRCheck){
        ...
        context.github.checks.update(updatePullRequestCheck)
